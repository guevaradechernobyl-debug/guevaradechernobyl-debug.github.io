...
function i(t) {
    ...
    function M(t) {
        if (t.touches.length > 0)
            for (let e = 0; e < t.touches.length; e++)
                C(t.touches[e].clientX, t.touches[e].clientY, v[Math.floor(Math.random() * v.length)])
    }
    function L(t) {
        if (e) {
    ...
    function k() {
        ...
        function() {
            ...
            for (let t = 0; t < I.length; t++)
                I[t].y = b[F.length + E + D.length + X.length + t] + 0 + t * R * Math.sin(i),
...
function d(t) {
    let e, n, i, o = t || {}, s = t && t.element, h = s || document.body, c = o.text ? " " + t.text : " Your Text Here", l = t?.color || "#000000", a = o.font || "monospace", r = o.textSize || 12, d = r + "px " + a, u = o.gap || r + 2, A = 0, m = [], g = window.innerWidth, f = window.innerHeight, p = {
        x: g / 2,
        y: g / 2
    };
...
export {h as bubbleCursor, i as characterCursor, r as clockCursor, c as emojiCursor, e as fairyDustCursor, s as followingDotCursor, l as ghostCursor, a as rainbowCursor, n as snowflakeCursor, t as springyEmojiCursor, d as textFlag, o as trailingCursor};
